...
# ----------------------------------------------------
# LIVE HUDDLE SIGNALING & WEBSOCKET STATE VIEWS (HEAD)
# ----------------------------------------------------
...
# ----------------------------------------------------
# MEETING SCHEDULING & CREATION VIEWS (Team-B)
# ----------------------------------------------------
...
def schedule_meeting(request):
    try:
        # Calls the internal meeting-service to generate a room link
        response = requests.post(
            "http://meeting-service:9000/create-room/",
            headers={
                "api_key": "huddle123"
            },
            json=request.data
