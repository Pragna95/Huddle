...
export default function TopBar() {
  return (
    <header className="w-full h-[75.59px]  bg-white border-b border-gray-200 flex items-center justify-end px-6 gap-3 flex-shrink-0">
      
      <Button className="bg-[#002266] hover:bg-[#152060] text-white text-[16px] rounded-[8px] pt-[12px] pr[20px] pb-[12px] pl-[20px] gap-[8px] h-[52px] w-[168px]  flex items-center gap-2">
