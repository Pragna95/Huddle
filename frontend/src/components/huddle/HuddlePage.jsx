...
export default function HuddlePage() {
    ...
    return (
    <div className="flex w-[1329px] h-[824px] bg-gray-50 overflow-hidden mx-auto">
        ...
        {/* Right Sidebar */}
        <aside className="w-[320px] h-full bg-gray-50 border-l border-gray-100 p-5 flex flex-col gap-5 overflow-y-auto">
            <CreateHuddle />
            <MiniCalendar />
        </aside>
