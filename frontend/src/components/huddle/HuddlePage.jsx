...
const navigate = useNavigate();
   ...
   return (
        <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex gap-3 mb-6">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <Input
                            ...
                            className="pl-9 border-gray-200 rounded-lg h-10 text-sm focus-visible:ring-0 focus-visible:ring-offset-0 focus:border-gray-200 outline-none"
                        />
                    </div>
                    <Button
                    ...
                    <div className="flex gap-6">
                        {TABS.map((tab) => (
                            <button
                                ...
                                className={`text-sm font-medium relative ${activeTab === tab
                                        ? "text-[#1e2b72]"
            ...
            {/* Right Sidebar */}
            <aside className="w-[480px] bg-gray-50 border-l border-gray-100 p-5 flex flex-col gap-5 overflow-y-auto flex-shrink-0">
                <CreateHuddle />
                <MiniCalendar />
            </aside>
  ...
  <DialogContent className="w-[500px] p-0 bg-white border border-gray-200 rounded-xl shadow-md">
    ...
    <div className="p-6">
      ...
      <div className="flex gap-3 justify-end">
        <Button
          variant="outline"
          className="border-[#002266] text-[#002266] hover:bg-[#002266] hover:text-white"
        ...
        <Button
          className="bg-[#1E2B72] hover:bg-[#17215A] text-white"
          onClick={() => {
